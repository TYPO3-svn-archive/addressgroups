...
class tx_addressgroups_addfilestosel {
    ...
    */
	function main(&$params,&$pObj)	{
		...
		$readPath = t3lib_div::getFileAbsFileName(
			$template->setup['plugin.']['tx_addressgroups_pi1.']['templatePath']
		);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/addressgroups/class.tx_addressgroups_addfilestosel.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/addressgroups/class.tx_addressgroups_addfilestosel.php']);
}
